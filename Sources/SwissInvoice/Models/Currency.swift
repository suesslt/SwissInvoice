...
/// Used as the currency component of `Money` for type-safe monetary amounts.
public enum Currency: String, Codable, CaseIterable, Identifiable, Sendable {
    ...
    // MARK: - Europe (except CHF, EUR, GBP)
    ...
    // MARK: - Common Currencies (for Picker)

    /// Commonly used currencies, shown first in pickers.
    public static let common: [Currency] = [.chf, .eur, .usd, .gbp, .jpy, .cad, .aud, .sek, .nok, .dkk, .pln, .czk, .huf, .cny]
    ...
    public var name: String {
        ...
        case .stn: return "São Tomé Dobra"
